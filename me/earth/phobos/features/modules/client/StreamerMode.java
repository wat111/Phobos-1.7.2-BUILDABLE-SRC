...
extends Module {
    ...
    public void onUpdate() {
        if (this.window != null) {
            ...
            boolean inHell = StreamerMode.mc.field_71441_e.func_180494_b(StreamerMode.mc.field_71439_g.func_180425_c()).func_185359_l().equals("Hell");
            int posX = (int)StreamerMode.mc.field_71439_g.field_70165_t;
            int posY = (int)StreamerMode.mc.field_71439_g.field_70163_u;
            int posZ = (int)StreamerMode.mc.field_71439_g.field_70161_v;
            float nether = !inHell ? 0.125f : 8.0f;
            int hposX = (int)(StreamerMode.mc.field_71439_g.field_70165_t * (double)nether);
            int hposZ = (int)(StreamerMode.mc.field_71439_g.field_70161_v * (double)nether);
