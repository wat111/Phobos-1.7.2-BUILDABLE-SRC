...
extends Module {
    ...
    public void onUpdateWalkingPlayer(UpdateWalkingPlayerEvent event) {
        if (this.mode.getValue() == Mode.DAMAGE) {
            if (this.format.getValue() == Format.DAMAGE) {
                if (event.getStage() == 0) {
                    ...
                    if (Flight.mc.field_71439_g.field_70122_E) {
                        ...
                        Phobos.positionManager.setPlayerPosition(Flight.mc.field_71439_g.field_70165_t, Flight.mc.field_71439_g.field_70181_x, Flight.mc.field_71439_g.field_70161_v);
            ...
            if (this.format.getValue() == Format.NORMAL) {
                Flight.mc.field_71439_g.field_70181_x = Flight.mc.field_71474_y.field_74314_A.func_151470_d() ? (double)this.speed.getValue().floatValue() : (Flight.mc.field_71474_y.field_74311_E.func_151470_d() ? (double)(-this.speed.getValue().floatValue()) : 0.0);
                if (this.noKick.getValue().booleanValue() && Flight.mc.field_71439_g.field_70173_aa % 5 == 0) {
                    Phobos.positionManager.setPlayerPosition(Flight.mc.field_71439_g.field_70165_t, Flight.mc.field_71439_g.field_70163_u - 0.03125, Flight.mc.field_71439_g.field_70161_v, true);
                }
        ...
        if (event.getStage() == 0) {
            ...
            if (this.mode.getValue() == Mode.VANILLA) {
                ...
                if (Flight.mc.field_71474_y.field_74314_A.func_151470_d()) {
                    Flight.mc.field_71439_g.field_70181_x = this.noKick.getValue().booleanValue() ? (Flight.mc.field_71439_g.field_70173_aa % 20 == 0 ? (double)-0.04f : (double)this.speed.getValue().floatValue()) : (Flight.mc.field_71439_g.field_70181_x += (double)this.speed.getValue().floatValue());
                }
                if (Flight.mc.field_71474_y.field_74311_E.func_151470_d()) {
    ...
    private void move(double x, double y, double z) {
        ...
        Object bounds = this.better.getValue() != false ? this.createBoundsPacket(x, y, z) : new CPacketPlayer.Position(Flight.mc.field_71439_g.field_70165_t + x, 0.0, Flight.mc.field_71439_g.field_70161_v + z, Flight.mc.field_71439_g.field_70122_E);
        this.packets.add((CPacketPlayer)bounds);
        Flight.mc.field_71439_g.field_71174_a.func_147297_a((Packet)bounds);
        ++this.teleportId;
