...
extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.isListening) {
            ...
            Phobos.textManager.drawStringWithShadow(this.setting.getName() + " " + "\u00a77" + ((Bind)this.setting.getValue()).toString(), this.x + 2.3f, this.y - 1.7f - (float)PhobosGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
        }
    }
