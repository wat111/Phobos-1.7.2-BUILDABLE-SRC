    ...
    extends ModelBase {
        ...
        public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
            for (ModelRenderer model : this.boxList) {
                GlStateManager.pushMatrix();
                GlStateManager.translate((float)model.offsetX, (float)model.offsetY, (float)model.offsetZ);
                GlStateManager.translate((float)(model.rotationPointX * f5), (float)(model.rotationPointY * f5), (float)(model.rotationPointZ * f5));
                GlStateManager.scale((double)1.0, (double)0.1, (double)1.0);
                GlStateManager.translate((float)(-model.offsetX), (float)(-model.offsetY), (float)(-model.offsetZ));
                GlStateManager.translate((float)(-model.rotationPointX * f5), (float)(-model.rotationPointY * f5), (float)(-model.rotationPointZ * f5));
                model.render(f5);
                GlStateManager.popMatrix();
