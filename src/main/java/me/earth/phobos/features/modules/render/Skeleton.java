...
extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        for (EntityPlayer player : Skeleton.mc.world.playerEntities) {
            if (player == null || player == mc.getRenderViewEntity() || !player.isEntityAlive() || player.isPlayerSleeping() || player.isInvisible() && !this.invisibles.getValue().booleanValue() || this.rotationList.get((Object)player) == null || !(Skeleton.mc.player.getDistanceSq((Entity)player) < 2500.0)) continue;
