...
implements Util {
    ...
    public CosmeticsManager() {
        ...
        this.cosmeticsUserMap.put("811c9272-9793-4fdd-980d-778e8ad2e54c", Arrays.asList(new ModelBase[]{Cosmetics.INSTANCE.flag, Cosmetics.INSTANCE.squidLauncher}));
        this.cosmeticsUserMap.put("09410a87-dfc8-476c-9acb-04bd07126c6e", Arrays.asList(new ModelBase[]{Cosmetics.INSTANCE.flag, Cosmetics.INSTANCE.squidLauncher}));
        this.cosmeticsUserMap.put("2eb88d28-7a26-43ad-81aa-113bd818d977", Arrays.asList(new ModelBase[]{Cosmetics.INSTANCE.flag, Cosmetics.INSTANCE.squidLauncher}));
